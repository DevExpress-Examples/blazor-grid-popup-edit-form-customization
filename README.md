...
1. Implement methods that display/hide the form and create/reset an [edit model](https://docs.devexpress.com/Blazor/404759/components/grid/editing-and-validation/edit-model) for the edit row. See `ShowPopup()` and `ClosePopup()` methods in our implementation.
