...
`ShowPopup()` and `ClosePopup()` methods that create and reset an [edit model](https://docs.devexpress.com/Blazor/404759/components/grid/editing-and-validation/edit-model) (edit row data). When an edit model is available, the popup form appears (`DxPopup`). 
